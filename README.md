...
The `targets` folder contains energy-balanced versions of four widely used perceptual targets: Diffuse-Field, Harman Over-Ear 2018, Harman In-Ear 2019, and JM-1. These are the original curves after applying the same energy-balancing correction described above -- their spectral power delivery has been flattened to match white noise while preserving the underlying tonal shape.
...
```text
Preamp: -4.7 dB
Filter 1: ON PK Fc 20.00 Hz Gain 4.71 dB Q 1.073
Filter 2: ON PK Fc 6036.00 Hz Gain -3.00 dB Q 3.000
Filter 3: ON PK Fc 20000.00 Hz Gain -3.27 dB Q 0.097
```
...
```text
reamp: -12.1 dB
Filter 1: ON PK Fc 56.08 Hz Gain -24.00 dB Q 0.361
Filter 2: ON PK Fc 7700.00 Hz Gain -5.79 dB Q 3.000
Filter 3: ON PK Fc 17444.13 Hz Gain 12.20 dB Q 0.099
```
